...
### Pulling Data Frames
Here, we pull four different data frames from the given orders schema. Notice how each data frame is saved, and then called with the head() command.
```{r, message=FALSE}
...
We can use ggplot to display the dataframes in a visual.
```{r, echo = FALSE}
